...
- [[#rice][RICE]]
  - [[#borders-gaps-color][BORDERS, GAPS, COLOR]]
  - [[#dwindle-layout-bspwm-like][Dwindle layout (BSPWM-like)]]
  - [[#master-layout-xmonad-like][Master layout (Xmonad like)]]
  - [[#gestures][Gestures]]
  - [[#border-rounding-blur][BORDER ROUNDING, BLUR]]
...
#+begin_src cpp
exec-once = swww init && ~/script/bash/swww/random ~/wallpaper/favourite/favfolder1 &
#+end_src
